...
export default defineConfig({
    shortcuts: [
        ...
        ['button-primary', 'border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:ring-blue-500'],
        ['button-secondary', 'border-transparent bg-red-600 text-white hover:bg-red-700 focus:ring-red-500'],
